...
var SortablisList = function SortablisList(_ref) {
    ...
    if (transitionId === null) {
      Object.keys(rowData).forEach(function (k) {
        var _rowData$k$style = rowData[k].style,
            ...
            style = _objectWithoutProperties(_rowData$k$style, ["transition", "position"]);
  ...
  var onDrag = (0, _react.useCallback)(function (event, data) {
    ...
    var newTop = row.style.top + data.deltaY;
  ...
  var onStop = (0, _react.useCallback)(function () {
    var newRowData = _objectSpread({}, rowData, _defineProperty({}, dragId, _objectSpread({}, rowData[dragId], {
      style: _objectSpread({}, rowData[dragId].style, {
        top: shadowStyle.top,
